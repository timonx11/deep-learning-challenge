...
## PS: All ANSWER, ANALYSYS AND H5 FILES ARE LOCATED UNDER "STARTER_CODE" FOLDER. I HAVE TO USED GOOGLE COLLAB AS TENSOR FLOW IS NOW WORKING PROPERLY ON MY LOCAL LAPTOP :(
...
## Files
Download the Starter Code to help you get started:
